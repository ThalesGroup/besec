...
// Validate validates this auth providers
func (m AuthProviders) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m AuthProviders) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
