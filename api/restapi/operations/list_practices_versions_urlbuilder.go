...
func (o *ListPracticesVersionsURL) WithBasePath(bp string) *ListPracticesVersionsURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *ListPracticesVersionsURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ListPracticesVersionsURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ListPracticesVersionsURL")
	}
