...
// GetPlanVersionsParams contains all the bound params for the get plan versions operation
...
func (o *GetPlanVersionsParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
