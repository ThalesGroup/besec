...
// DeletePlanParams contains all the bound params for the delete plan operation
...
func (o *DeletePlanParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
