...
func (o *GetPlanRevisionURL) Build() (*url.URL, error) {
	...
	var _path = "/plan/{id}/revision/{revId}"

	id := o.ID
	if id != "" {
		_path = strings.Replace(_path, "{id}", id, -1)
	} else {
		return nil, errors.New("id is required on GetPlanRevisionURL")
	}
	...
	if revID != "" {
		...
		return nil, errors.New("revId is required on GetPlanRevisionURL")
	}
...
func (o *GetPlanRevisionURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetPlanRevisionURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetPlanRevisionURL")
	}
