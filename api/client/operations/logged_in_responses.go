...
func (o *LoggedInReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewLoggedInOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewLoggedInDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *LoggedInOK) Error() string {
	return fmt.Sprintf("[POST /auth][%d] loggedInOK ", 200)
}

func (o *LoggedInOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *LoggedInDefault) Error() string {
	return fmt.Sprintf("[POST /auth][%d] loggedIn default  %+v", o._statusCode, o.Payload)
}
func (o *LoggedInDefault) GetPayload() *models.Error {
	return o.Payload
}

func (o *LoggedInDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
